# ============================================================================
# Purpose:      Figure 2E: post-vaccination APRIL (TNFSF13) vs serum M-spike Spearman correlation in treatment-naive SMM patients with a quantifiable M-spike. Includes nonparametric bootstrap CI on rho and a log10 Pearson sensitivity.
# Inputs:       data/olink/olink_summary_tumor_burden.csv.
# Outputs:      figures/Figure2E.png with the Spearman rho, p-value and bootstrap CI annotated.
# Dependencies: R + tidyverse; sources ../config.R.
# ============================================================================
source("../config.R")
library(tidyverse)
...
# (10,000 resamples) for a 95% CI on the Spearman rho, and a Pearson sensitivity on log10-APRIL.
...
p <- ggplot(bm_post) +
  ...
  annotate("text", x = Inf, y = Inf,
           label = paste0("Spearman ρ = ", rho_str, "\n",
                          ...
                          "p = ", p_value),
           color = "black", size = 3.4, hjust = 1.05, vjust = 1.3,
           lineheight = 1.05) +
