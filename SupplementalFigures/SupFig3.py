#!/usr/bin/env python3
"""Supplemental Figure 3: Individual APRIL-responsive gene violin plots (HD vs SMM)."""
...
plt.savefig(FIGURES_DIR / "SupFig3.png", dpi=300, bbox_inches='tight')
plt.close()
print("Saved: SupFig3.png")
