#!/usr/bin/env python3
"""Supplementary Figure 3A: bone-marrow myeloid TNFSF13 (APRIL) expression across HD/MGUS/SMM/MM.
...
Outputs:      figures/SupFig3A.png (and PDF + SVG); tables/zavidij_bm_per_sample_summary.csv,
